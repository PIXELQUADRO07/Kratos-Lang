...
declarations and action-oriented vocabulary. Version **0.2.0** ships a lexer,
...
Version 0.2.0 freezes the implemented grammar in
...
6. Tests and a versioned specification. **Done (0.2.0).**
